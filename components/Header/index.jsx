            ...
            <div className={styles.container}>
                ...
                <div className={styles.floatLeft}>
                    ...
                    <ul className={styles.ul}>
                        <li className={styles.list} key={0}>
                            <a className={styles.a} href="https://www.linkedin.com/in/lucas85235/" target="_blank" rel="noreferrer">
                        ...
                        <li className={styles.list} key={1}>
                            <a className={styles.a} href="https://github.com/lucas85235" target="_blank" rel="noreferrer">
